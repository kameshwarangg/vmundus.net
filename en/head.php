...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1YB7SQV9KC"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1YB7SQV9KC');
</script>
	...
	<title><?php	
		...
		elseif($p_title == '/en/millitary_stat') {
			...
			elseif($p_title == '/en/regions_stat') {
			echo "Nations";
		}
		elseif($p_title == '/en/players_stat') {
			echo "Top Players";
		}
		elseif($p_title == '/en/party_stat') {
			echo "Top Parties";
		}
	...
	<?php 
		if($p_title == '/en/index' || 
		   $p_title == '/en/'){
			...
			echo '<link rel="stylesheet" href="../css/active_battles_index.css?' . filemtime('../css/active_battles_index.css') . '">';
		}
		...
		elseif($p_title == '/en/regions_stat') {
			echo '<link rel="stylesheet" href="../css/regions_stat.css?' . 
				  filemtime('../css/regions_stat.css') . '">';
		}
		elseif($p_title == '/en/players_stat') {
			echo '<link rel="stylesheet" href="../css/players_stat.css?' . 
				  filemtime('../css/players_stat.css') . '">';
		}
		elseif($p_title == '/en/party_stat') {
			echo '<link rel="stylesheet" href="../css/party_stat.css?' . 
				  filemtime('../css/party_stat.css') . '">';
		}
		elseif($p_title == '/en/black_market') {
	...
	<?php
		...
		elseif($p_title == '/en/regions_stat') {
			echo '<script src="../js/main_script.js?' . filemtime('../js/main_script.js') . '"></script>';
		}
		elseif($p_title == '/en/players_stat') {
			echo '<script src="../js/players_stat.js?' . filemtime('../js/players_stat.js') . '"></script>';
		}
		elseif($p_title == '/en/party_stat') {
			echo '<script src="../js/parties.js?' . filemtime('../js/parties.js') . '"></script>';
		}
	...
	<ul>
		<?php
			echo "\n\t\t" . '<li id="economy">' .
				 ...
				 "\n\t\t\t\t" . '<a href="regions_stat"><li class="subli">Nations</li></a>' .
				 "\n\t\t\t" . '</ul>' .
				 "\n\t\t" . '</li>' .
				 "\n\t\t" . '<li id="social">' .
						    $lang['social'] .
